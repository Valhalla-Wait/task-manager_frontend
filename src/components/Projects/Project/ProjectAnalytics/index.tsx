...
export const ProjectAnalytics = () => {
  const [usersAnalyticsStatus, setUsersAnalyticsStatus] =
    useState<TaskStatuses>(TaskStatuses.Completed);
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.analytics}>
        ...
        <Menu
          ...
          onClick={changeAnalyticsStatus}
          selectedKeys={[usersAnalyticsStatus]}
          mode="horizontal"
          items={menuItems}
        />
        <ResponsiveContainer className={styles.chart}>
          ...
          >
            ...
            <Legend />
            <Bar
              dataKey={usersAnalyticsStatus}
              fill={getStatusColor(usersAnalyticsStatus)}
            />
          </BarChart>
        </ResponsiveContainer>
      </div>
