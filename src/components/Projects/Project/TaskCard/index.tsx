...
import { Button, Divider, Dropdown, Form, Input, InputNumber, InputNumber as InputNumberAnt, InputNumberProps, List, List as ListAnt, ListProps, MenuProps, Modal, Select, Space } from 'antd';
...
type StatusType = 'IN WORK' | 'NEW' | 'COMPLETED' | 'REJECTED' | 'NOT COMPLETED'
    ...
    return (
        ...
        <div className={styles.wrapper}>
            ...
            >
                    ...
                    <Input onChange={() => console.log('executor')} autoFocus placeholder="Add task executor" />
                    </Form.Item>
                    </Form>
